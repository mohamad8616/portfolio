...
function Navbar() {
  ...
  return (
    <nav className="sticky top-0 flex h-full items-center justify-between gap-x-3 bg-white px-4 text-xl text-slate-800 dark:bg-black dark:text-slate-200 sm:px-8 md:px-12 lg:px-20 xl:px-48">
      <ThemeToggle />
